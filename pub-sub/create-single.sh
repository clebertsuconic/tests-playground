...
$BROKER/bin/artemis create --silent --force --user artemis --password artemis --role amq --port-offset 0 --allow-anonymous --name node1 --max-hops 1 --queues amqp-demo-queue node1 --java-options "$AGENT_OPTIONS"
